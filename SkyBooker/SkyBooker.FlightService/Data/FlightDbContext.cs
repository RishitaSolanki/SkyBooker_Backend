...
public class FlightDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Flight>().HasData(
            new Flight { FlightId = 1, FlightNumber = "AI101", AirlineId = 1, OriginAirportCode = "DEL", DestinationAirportCode = "BOM", DepartureTime = new DateTime(2026, 5, 14, 6, 0, 0, DateTimeKind.Utc), ArrivalTime = new DateTime(2026, 5, 14, 8, 30, 0, DateTimeKind.Utc), DurationMinutes = 150, AircraftType = "Boeing 787", TotalSeats = 250, AvailableSeats = 180, BusinessPrice = 8500.00M, EconomyPrice = 5500.00M, Status = Common.Enums.FlightStatus.Scheduled, CreatedAt = new DateTime(2026, 4, 27, 0, 0, 0, DateTimeKind.Utc) },
            new Flight { FlightId = 2, FlightNumber = "6E202", AirlineId = 2, OriginAirportCode = "BOM", DestinationAirportCode = "BLR", DepartureTime = new DateTime(2026, 5, 14, 10, 0, 0, DateTimeKind.Utc), ArrivalTime = new DateTime(2026, 5, 14, 11, 45, 0, DateTimeKind.Utc), DurationMinutes = 105, AircraftType = "Airbus A320", TotalSeats = 180, AvailableSeats = 120, BusinessPrice = 6200.00M, EconomyPrice = 4200.00M, Status = Common.Enums.FlightStatus.Scheduled, CreatedAt = new DateTime(2026, 4, 27, 0, 0, 0, DateTimeKind.Utc) },
            new Flight { FlightId = 3, FlightNumber = "UK303", AirlineId = 4, OriginAirportCode = "DEL", DestinationAirportCode = "BOM", DepartureTime = new DateTime(2026, 5, 14, 18, 0, 0, DateTimeKind.Utc), ArrivalTime = new DateTime(2026, 5, 14, 20, 30, 0, DateTimeKind.Utc), DurationMinutes = 150, AircraftType = "Airbus A321", TotalSeats = 200, AvailableSeats = 45, BusinessPrice = 9200.00M, EconomyPrice = 6200.00M, Status = Common.Enums.FlightStatus.Scheduled, CreatedAt = new DateTime(2026, 4, 27, 0, 0, 0, DateTimeKind.Utc) },
            new Flight { FlightId = 4, FlightNumber = "SG404", AirlineId = 3, OriginAirportCode = "DEL", DestinationAirportCode = "BOM", DepartureTime = new DateTime(2026, 5, 15, 7, 30, 0, DateTimeKind.Utc), ArrivalTime = new DateTime(2026, 5, 15, 10, 0, 0, DateTimeKind.Utc), DurationMinutes = 150, AircraftType = "Boeing 737", TotalSeats = 180, AvailableSeats = 90, BusinessPrice = 7200.00M, EconomyPrice = 4800.00M, Status = Common.Enums.FlightStatus.Scheduled, CreatedAt = new DateTime(2026, 4, 27, 0, 0, 0, DateTimeKind.Utc) },
            new Flight { FlightId = 5, FlightNumber = "AI102", AirlineId = 1, OriginAirportCode = "BOM", DestinationAirportCode = "DEL", DepartureTime = new DateTime(2026, 5, 14, 21, 0, 0, DateTimeKind.Utc), ArrivalTime = new DateTime(2026, 5, 14, 23, 30, 0, DateTimeKind.Utc), DurationMinutes = 150, AircraftType = "Boeing 787", TotalSeats = 250, AvailableSeats = 200, BusinessPrice = 8200.00M, EconomyPrice = 5200.00M, Status = Common.Enums.FlightStatus.Scheduled, CreatedAt = new DateTime(2026, 4, 27, 0, 0, 0, DateTimeKind.Utc) }
        );
    }
}