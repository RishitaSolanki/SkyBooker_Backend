    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Flight>().HasData(
            new Flight
            {
                ...
                DepartureTime = new DateTime(2025, 5, 1, 6, 0, 0, DateTimeKind.Utc),
                ArrivalTime = new DateTime(2025, 5, 1, 8, 30, 0, DateTimeKind.Utc),
                DurationMinutes = 150,
                AircraftType = "Boeing 787",
                TotalSeats = 250,
                AvailableSeats = 180,
                BasePrice = 5500.00M,
                Status = Common.Enums.FlightStatus.Scheduled,
                CreatedAt = new DateTime(2025, 4, 23, 10, 0, 0, DateTimeKind.Utc)
            },
            new Flight
            {
                FlightId = 2,
                ...
                ArrivalTime = new DateTime(2025, 5, 1, 11, 45, 0, DateTimeKind.Utc),
                DurationMinutes = 105,
